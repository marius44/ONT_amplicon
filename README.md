...
El segundo, Analisis_emu_(pasarlo_a_R).md, es un pipeline corto que utiliza al programa Emu. Con este comienza propiamente el análisis de sus secuencias. A l usar esto, filtrará sus fastq y generará un archivo **.filtered.fastq** por cada uno de sus archivos fastq. Con los archivos **filtrados** se generarán en una  carpeta llamada **emu_results** una serie de archivos **_rel-abundance.tsv**. Estos son los que alimentarán al siguiente paso de análisis.
